...
const PIPDF = ({ ticketData, companyInfo }) => {
  ...
  const clientPhone = String(ticket.clientPhone ?? '');
  const clientGstNumber = String(ticket.clientGstNumber ?? '');
  ...
  const formatCityStatePin = (city, state, pincode) => {
    let parts = [city, state].filter(Boolean);
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.pageBorder}>
          ...
          <View style={styles.addressTable}>
            ...
            <View style={styles.addressRow}>
              ...
              <Text style={styles.addressCellData}>
                {String(ticket.client?.companyName || ticket.companyName || '')}
              </Text>
            ...
            <View style={styles.addressRow}>
              ...
              <Text style={styles.addressCellData}>{String(billingState ?? '')}</Text>
              <Text style={styles.addressCellDataLast}>{String(shippingState ?? '')}</Text>
            </View>
            <View style={styles.addressRow}>
          ...
          <View style={styles.termsConditionsContainer}>
            <View style={styles.termsConditionsBox}>
